(function (global) {
  const icons = {
    ...
    'git-pull-request-arrow': '<circle cx="5" cy="6" r="3"/><path d="M5 9v12"/><path d="m15 9-3-3 3-3"/><path d="M12 6h5a2 2 0 0 1 2 2v3"/><circle cx="19" cy="18" r="3"/><path d="M15 18H5"/>',
    ...
    'save-all': '<path d="M10 2v3a1 1 0 0 0 1 1h5"/><path d="M18 18v-6a1 1 0 0 0-1-1h-6a1 1 0 0 0-1 1v6"/><path d="M18 22H4a2 2 0 0 1-2-2V6"/><path d="M8 22v-4h10v4"/><path d="M21.5 16.5 22 8.8a2 2 0 0 0-.6-1.5l-4.7-4.7A2 2 0 0 0 15.2 2H8a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h11.5"/>',
  ...
  function svgFor(name) {
    ...
    if (!body) return null;
    return `<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-${name}" aria-hidden="true">${body}</svg>`;
  }
  ...
  function createIcons(options) {
    ...
    root.querySelectorAll('[data-lucide]').forEach((node) => {
      ...
      Array.from(node.attributes).forEach((attr) => {
        ...
        if (!svg.hasAttribute(attr.name)) svg.setAttribute(attr.name, attr.value);
      });
      node.replaceWith(svg);
    });
  }

  global.lucide = { createIcons, icons };
})(window);
